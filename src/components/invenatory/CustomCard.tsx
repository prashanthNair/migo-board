...
const CustomCard = (props:any) => {
  ...
  const postProductDetails = async () => {
    const response = await dispatch(ProductDetailsData(data));
  };
  // useEffect(() => {
  //   postProductDetails();
  // });
    ...
    <CardBody onDoubleClick={handleDoubleClick}>
      ...
      <DetailBox>
        <TopHeading>
          ...
          <MoreHorizIcon style={{ marginLeft: '70px', color: 'grey' }} />
        </TopHeading>
        <Points>
          Buddy Margin:
          {data.BuddyMargin}
